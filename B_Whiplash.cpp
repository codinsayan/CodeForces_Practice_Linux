...
void solve() {
    ...
    else if(n==2) {cout<<2<<endl; return;}
    else if(n==3) {cout<<2<<endl; return;}

    if(n%2==0) cout<<setprecision(0)<<fixed<<n*3/4+1<<endl;
    else {
        if((n+1)%4 == 0) cout<<(n+1)/4+1<<endl;
        else if((n-1)%4 == 0) cout<<(n-1)/4+1<<endl;
    }
