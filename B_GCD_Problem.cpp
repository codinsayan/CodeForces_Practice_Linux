...
void solve() {
    ...
    else if(n%2 != 0 && ((n-1)/2)%2==0) cout<<(n-1)/2-1<<" "<<(n-1)/2+1<<" "<<1<<endl;
...
//Took time only because I went straight into implementation of gcd where it wasn't even needed
//think this kind of problems a bit and analyze without directly using the gcd algorithm...
//don't jump straight into algorithms, give a bit thought if it can be solved without it 